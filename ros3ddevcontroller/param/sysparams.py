...
SYSTEM_PARAMETERS = [
    ...
    Parameter('dof_total_m', 0, float, evaluated=True, evaluator=DofTotalCalc),
    ...
    Parameter('parallax_object1_mm', 0, float, evaluated=True, evaluator=ParallaxObject1MMCalc),
    ...
    Parameter('real_height_near_m', 0, float, evaluated=True, evaluator=RealHeightNearCalc),
    Parameter('real_width_screen_m', 0, float, evaluated=True, evaluator=RealWidthScreenCalc),
    Parameter('real_height_screen_m', 0, float, evaluated=True, evaluator=RealHeightScreenCalc),
    Parameter('real_width_far_m', 0, float, evaluated=True, evaluator=RealHeightFarCalc),
    Parameter('real_height_far_m', 0, float, evaluated=True, evaluator=RealHeightFarCalc),
    Parameter('real_width_object1_m', 0, float, evaluated=True, evaluator=RealWidthObject1Calc),
    Parameter('real_height_object1_m', 0, float, evaluated=True, evaluator=RealHeightObject1Calc),
    Parameter('real_width_object2_m', 0, float, evaluated=True, evaluator=RealWidthObject2Calc),
    Parameter('real_height_object2_m', 0, float, evaluated=True, evaluator=RealHeightObject2Calc),
    ...
    Parameter('perceived_position_near_percent', 0, float, evaluated=True, evaluator=PerceivedPositionNearPercCalc),
    Parameter('perceived_position_screen_percent', 0, float, evaluated=True, evaluator=PerceivedPositionScreenPercCalc),
    Parameter('perceived_position_far_percent', 0, float, evaluated=True, evaluator=PerceivedPositionFarPercCalc),
    Parameter('perceived_position_object1_percent', 0, float, evaluated=True, evaluator=PerceivedPositionObject1PercCalc),
    Parameter('perceived_position_object2_percent', 0, float, evaluated=True, evaluator=PerceivedPositionObject2PercCalc),
    Parameter('perceived_position_near_m', 0, float, evaluated=True, evaluator=PerceivedPositionNearMCalc),
    Parameter('perceived_position_screen_m', 0, float, evaluated=True, evaluator=PerceivedPositionScreenMCalc),
    Parameter('perceived_position_far_m', 0, float, evaluated=True, evaluator=PerceivedPositionFarMCalc),
    Parameter('perceived_position_object1_m', 0, float, evaluated=True, evaluator=PerceivedPositionObject1MCalc),
    Parameter('perceived_position_object2_m', 0, float, evaluated=True, evaluator=PerceivedPositionObject2MCalc),
