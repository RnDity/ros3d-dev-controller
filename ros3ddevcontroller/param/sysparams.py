...
SYSTEM_PARAMETERS = [
    ...
    Parameter('parallax_near_percent', 0, float,
              evaluated=True, evaluator=ParallaxNearPercentCalc),
    Parameter('parallax_screen_percent', 0, float),
    Parameter('parallax_far_percent', 0, float,
              evaluated=True, evaluator=ParallaxFarPercentCalc),
    Parameter('parallax_object1_percent', 0, float,
              evaluated=True, evaluator=ParallaxObject1PercentCalc),
    Parameter('parallax_object2_percent', 0, float,
              evaluated=True, evaluator=ParallaxObject2PercentCalc),
    ...
    Parameter('spectator_fov_horizontal_deg', 0, float,
              evaluated=True, evaluator=SpectatorFovHorizontalDegCalc),
    Parameter('perceived_position_near_percent', 0, float,
              evaluated=True, evaluator=PerceivedPositionNearPercCalc),
    Parameter('perceived_position_screen_percent', 0, float,
              evaluated=True, evaluator=PerceivedPositionScreenPercCalc),
    Parameter('perceived_position_far_percent', 0, float,
              evaluated=True, evaluator=PerceivedPositionFarPercCalc),
    Parameter('perceived_position_object1_percent', 0,
              float, evaluated=True, evaluator=PerceivedPositionObject1PercCalc),
    Parameter('perceived_position_object2_percent', 0, float,
              evaluated=True, evaluator=PerceivedPositionObject2PercCalc),
    Parameter('perceived_position_near_m', 0, float,
              evaluated=True, evaluator=PerceivedPositionNearMCalc),
    Parameter('perceived_position_screen_m', 0, float,
              evaluated=True, evaluator=PerceivedPositionScreenMCalc),
    Parameter('perceived_position_far_m', 0, float,
              evaluated=True, evaluator=PerceivedPositionFarMCalc),
    Parameter('perceived_position_object1_m', 0, float,
              evaluated=True, evaluator=PerceivedPositionObject1MCalc),
    Parameter('perceived_position_object2_m', 0, float,
              evaluated=True, evaluator=PerceivedPositionObject2MCalc),
